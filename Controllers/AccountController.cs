...
namespace WebChatPlay.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(ILogger<AccountController> logger, IMessagesRepository repo)
        {
            this.logger = logger;
            this.repo = repo;
        }
        ...
        public async Task<IActionResult> FakeLogin(string userName)
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new Claim(ClaimTypes.Role, "ChatUser")
            };
